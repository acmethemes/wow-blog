...
if ( ! class_exists( 'Read_More_Theme_Info' ) ) {
	class Read_More_Theme_Info {
		...
		public function at_theme_info_welcome_admin_notice() {
			...
			echo ( '<p>' . sprintf( __( 'Welcome! Thank you for choosing %1$s! To fully take advantage of the best our theme can offer please make sure you visit our %2$swelcome page%3$s.', 'wow-blog' ), $this->theme_name, '<a href="' . esc_url( admin_url( 'themes.php?page=' . $this->theme_slug . '-info' ) ) . '">', '</a>' ) . '</p><p><a href="' . esc_url( admin_url( 'themes.php?page=' . $this->theme_slug . '-info' ) ) . '" class="button" style="text-decoration: none;">' . sprintf( __( 'Get started with %s', 'wow-blog' ), $this->theme_name ) . '</a></p>' );
			echo '</div>';
		}
		...
		public function get_config() {
			...
			return array(
				// Page title.
				'page_title'          => esc_html__( 'WOW Blog Info', 'wow-blog' ),

				// Menu name under Appearance.
				'menu_title'          => esc_html__( 'WOW Blog Info', 'wow-blog' ),

				// Main welcome title
				'info_title'          => sprintf( esc_html__( 'Welcome to %s - ', 'wow-blog' ), 'WOW Blog' ),

				// Main welcome content
				'info_content'        => sprintf( esc_html__( '%s is now installed and ready to use. We hope the following information will help you. If you want to ask any query or just want to say hello, you can always contact us. We hope you enjoy it! ', 'wow-blog' ), '<b>WOW Blog</b>' ),
				...
				'quick_links'         => array(
					'theme_url' => array(
						'text' => __( 'Theme Details', 'wow-blog' ),
						'url'  => 'https://www.acmethemes.com/themes/wow-blog/',
					),
					'demo_url'  => array(
						'text' => __( 'View Demo', 'wow-blog' ),
						'url'  => 'http://www.demo.acmethemes.com/wow-blog/',
					),
					'pro_url'   => array(
						'text' => __( 'View Pro Version', 'wow-blog' ),
						'url'  => 'https://www.acmethemes.com/themes/read-more-pro/',
					),
					'rate_url'  => array(
						'text' => __( 'Rate This Theme', 'wow-blog' ),
						'url'  => 'https://wordpress.org/support/theme/wow-blog/reviews/?filter=5',
					),
				),
				 ...
				 * Tabs array.
				 *'tabs'                    => array(
				'getting_started'  => __( 'Getting Started', 'wow-blog' ),
				'recommended_actions' => __( 'Recommended Actions', 'wow-blog' ),
				'recommended_plugins' => __( 'Useful Plugins','wow-blog' ),
				'support'       => __( 'Support', 'wow-blog' ),
				'changelog'        => __( 'Changelog', 'wow-blog' ),
				'faq'        => __( 'FAQ', 'wow-blog' ),
				'free_pro'         => __( 'Free VS PRO', 'wow-blog' ),
				),
				...
				'getting_started'     => array(
					'first'  => array(
						'title'               => esc_html__( 'Step 1 : Read full documentation', 'wow-blog' ),
						'desc'                => esc_html__( 'Please check our full documentation for detailed information on how to Setup and Use WOW Blog.', 'wow-blog' ),
						'link_title'          => esc_html__( 'Documentation', 'wow-blog' ),
						'link_url'            => 'http://www.doc.acmethemes.com/wow-blog/',
						'is_button'           => false,
						'recommended_actions' => false,
						'is_new_tab'          => true,
					),
					'second' => array(
						'title'               => esc_html__( 'Step 2 : Go to Customizer', 'wow-blog' ),
						'desc'                => esc_html__( 'All Setting, Theme Options, Widgets and Menus are available via Customize screen. Have a quick look or start customization!', 'wow-blog' ),
						'link_title'          => esc_html__( 'Go to Customizer', 'wow-blog' ),
					...
					'third'  => array(
						'title'               => esc_html__( 'Step 3 : Setting Featured Section ', 'wow-blog' ),
						'desc'                => esc_html__( 'Add Feature Image or Unlimited Slides on Front/Home Page.', 'wow-blog' ),
						'link_title'          => esc_html__( 'Featured Section', 'wow-blog' ),
						'link_url'            => esc_url( admin_url( 'customize.php' ) ) . '?autofocus[panel]=wow-blog-feature-panel',
						'is_button'           => true,
						'recommended_actions' => false,
						'is_new_tab'          => true,
					),
					'forth'  => array(
						'title'               => esc_html__( 'Step 3 : Setting Blog Featured Section ', 'wow-blog' ),
						'desc'                => esc_html__( 'Add Blog Feature on Blog Page', 'wow-blog' ),
						'link_title'          => esc_html__( 'Blog Featured Section', 'wow-blog' ),
						'link_url'            => esc_url( admin_url( 'customize.php' ) ) . '?autofocus[panel]=wow-blog-feature-blog-panel',
						'is_button'           => true,
						'recommended_actions' => false,
						'is_new_tab'          => true,
					),
				...
				'recommended_actions' => array(
					'demo-content' => array(
						'title'       => esc_html__( 'Install Demo Setup', 'wow-blog' ),
						'desc'        => sprintf( esc_html__( 'For the demo content installation, install the Acme Demo Setup plugin, download demo content from %1$s here %2$s. Then go to "Acme Demo Setup" and import demo. ', 'wow-blog' ), '<a target="_blank" href="http://www.doc.acmethemes.com/wow-blog/#DummyData" >', '</a>' ),
						'id'          => 'acme-demo-setup',
				...
				'faq'                 => array(
					'first'  => array(
						'title'        => esc_html__( 'Where to get a dedicated support ? ', 'wow-blog' ),
						'icon'         => 'dashicons dashicons-sos',
						'desc'         => esc_html__( 'Follow the theme dedicated support forum.', 'wow-blog' ),
						'button_label' => esc_html__( 'Click here to get the support', 'wow-blog' ),
						'button_link'  => esc_url( 'https://www.acmethemes.com/supports' ),
						'is_button'    => true,
						'is_new_tab'   => true,
					),
					'second' => array(
						'title'        => esc_html__( 'Recent Updates of your Site ? ', 'wow-blog' ),
						'icon'         => 'dashicons dashicons-sos',
						'desc'         => esc_html__( 'Where i can get the recent updates of theme related updates ? ', 'wow-blog' ),
						'button_label' => esc_html__( 'Visit our site blog page', 'wow-blog' ),
						'button_link'  => esc_url( 'https://www.acmethemes.com/blog/' ),
						'is_button'    => true,
						'is_new_tab'   => true,
					),
					'third'  => array(
						'title'        => esc_html__( 'How to hide/change footer text Proudly powered by WordPress | Theme: WOW Blog by AcmeThemes. ? ', 'wow-blog' ),
						'icon'         => 'dashicons dashicons-sos',
						'button_label' => esc_html__( 'Visit this blog post to know how to change or remove powered by text.', 'wow-blog' ),
						'button_link'  => esc_url( 'https://www.acmethemes.com/blog/2017/01/remove-powered-by-text-on-footer/' ),
						'is_button'    => true,
						'is_new_tab'   => true,
					),
					'forth'  => array(
						'title'        => esc_html__( 'What is the different between free and pro theme ? ', 'wow-blog' ),
						'icon'         => 'dashicons dashicons-sos',
						'button_label' => esc_html__( 'Visit this blog post to know free vs pro.', 'wow-blog' ),
				...
				'support_content'     => array(
					'first'  => array(
						'title'        => esc_html__( 'Contact Support', 'wow-blog' ),
						'icon'         => 'dashicons dashicons-sos',
						'desc'         => esc_html__( 'Got theme support question or found bug? Best place to ask your query is our dedicated Support forum.', 'wow-blog' ),
						'button_label' => esc_html__( 'Contact Support', 'wow-blog' ),
						'button_link'  => esc_url( 'https://www.acmethemes.com/supports/forum/wow-blog/' ),
						'is_button'    => true,
						'is_new_tab'   => true,
					),
					'second' => array(
						'title'        => esc_html__( 'Documentation', 'wow-blog' ),
						'icon'         => 'dashicons dashicons-book-alt',
						'desc'         => esc_html__( 'Please check our full documentation for detailed information on how to Setup and Use WOW Blog.', 'wow-blog' ),
						'button_label' => esc_html__( 'Read full documentation', 'wow-blog' ),
						'button_link'  => 'http://www.doc.acmethemes.com/wow-blog/',
						'is_button'    => false,
						'is_new_tab'   => true,
					),
					'third'  => array(
						'title'        => esc_html__( 'Need more features?', 'wow-blog' ),
						'icon'         => 'dashicons dashicons-screenoptions',
						'desc'         => esc_html__( 'Upgrade to PRO version for more exciting features and Priority Support.', 'wow-blog' ),
						'button_label' => esc_html__( 'View Pro Version', 'wow-blog' ),
						'button_link'  => 'https://www.acmethemes.com/themes/read-more-pro/',
						'is_button'    => true,
						'is_new_tab'   => true,
					),
					'fourth' => array(
						'title'        => esc_html__( 'Got sales related question?', 'wow-blog' ),
						'icon'         => 'dashicons dashicons-cart',
						'desc'         => esc_html__( 'Have any query before purchase, you are more than welcome to ask.', 'wow-blog' ),
						'button_label' => esc_html__( 'Pre-sale Question?', 'wow-blog' ),
						'button_link'  => 'https://www.acmethemes.com/pre-sale-question/',
						'is_button'    => true,
						'is_new_tab'   => true,
					),
					'fifth'  => array(
						'title'        => esc_html__( 'Customization Request', 'wow-blog' ),
						'icon'         => 'dashicons dashicons-hammer',
						'desc'         => esc_html__( 'Needed any customization for the theme, you can request from here.', 'wow-blog' ),
						'button_label' => esc_html__( 'Customization Request', 'wow-blog' ),
				...
				'free_pro'            => array(
					array(
						'title' => __( 'Custom Widgets', 'wow-blog' ),
						'desc'  => __( 'All added custom widgets are ready for page builder plugin', 'wow-blog' ),
						'free'  => __( '3+ ', 'wow-blog' ),
						'pro'   => __( '7+ Available', 'wow-blog' ),
					),
					array(
						'title' => __( 'Widget Options', 'wow-blog' ),
						'desc'  => __( 'Every widgets have multiple options to customize section', 'wow-blog' ),
						'free'  => __( 'Limited Options', 'wow-blog' ),
						'pro'   => __( 'Multiple Options', 'wow-blog' ),
					),
					array(
						'title' => __( 'Menu Location', 'wow-blog' ),
						'desc'  => __( 'This theme have 2 menu location', 'wow-blog' ),
						'free'  => __( '2', 'wow-blog' ),
						'pro'   => __( '2', 'wow-blog' ),
					),
					array(
						'title' => __( 'Google Fonts', 'wow-blog' ),
						'desc'  => __( 'Google fonts options for changing the overall site fonts ', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => __( '100 +', 'wow-blog' ),
					),
					array(
						'title' => __( 'Color Options', 'wow-blog' ),
						'desc'  => __( 'Color options for changing overall site colors, Contat us', 'wow-blog' ),
						'free'  => __( '2', 'wow-blog' ),
						'pro'   => __( 'Unlimited', 'wow-blog' ),
					),
					array(
						'title' => __( 'Header Options', 'wow-blog' ),
						'desc'  => __( 'Customze the header section as your need.', 'wow-blog' ),
						'free'  => __( 'Limited', 'wow-blog' ),
						'pro'   => __( 'Multiple Options', 'wow-blog' ),
					),
					array(
						'title' => __( 'Menu Options', 'wow-blog' ),
						'desc'  => __( 'Lots of menu options are available to manage the menu section. Appearance > Menus', 'wow-blog' ),
						'free'  => __( 'Limited', 'wow-blog' ),
						'pro'   => __( 'Multiple Options', 'wow-blog' ),
					),
					array(
						'title' => __( 'Sticky Menu Options', 'wow-blog' ),
						'desc'  => __( 'Enable Sticky menu on your site.', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Featured Selection', 'wow-blog' ),
						'desc'  => __( 'This is slider section. Check every options there', 'wow-blog' ),
						'free'  => __( 'Recent Post/Category', 'wow-blog' ),
						'pro'   => __( 'Page, Post, Category, Custom & Third party', 'wow-blog' ),
					),
					array(
						'title' => __( 'Featured Section Options', 'wow-blog' ),
						'desc'  => __( 'Options to manage the sliders', 'wow-blog' ),
						'free'  => __( 'Limited', 'wow-blog' ),
						'pro'   => __( 'Multiple Options', 'wow-blog' ),
					),
					array(
						'title' => __( 'Featured Blog Section', 'wow-blog' ),
						'desc'  => __( 'Options to manage the Blog Section', 'wow-blog' ),
						'free'  => __( 'Limited', 'wow-blog' ),
						'pro'   => __( 'Multiple Options', 'wow-blog' ),
					),
					array(
						'title' => __( 'Featured Blog Options', 'wow-blog' ),
						'desc'  => __( 'Options to manage the Blog Section', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Sticky Sidebar', 'wow-blog' ),
						'desc'  => __( 'Enable/Disable sticky sidebars', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Blog/Archive Options', 'wow-blog' ),
						'desc'  => __( 'Various Options are available for the blog and archive page management. Check on Appearance > Customize > Layout/Design Options.', 'wow-blog' ),
						'free'  => __( 'Limited', 'wow-blog' ),
						'pro'   => __( 'Manage Every Entity', 'wow-blog' ),
					),
					array(
						'title' => __( 'Meta Options', 'wow-blog' ),
						'desc'  => __( 'Options to show/hide meta tags.', 'wow-blog' ),
						'free'  => 'no',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Footer Options', 'wow-blog' ),
						'desc'  => __( 'Manage the every entity related to footer section.', 'wow-blog' ),
						'free'  => __( 'Limited', 'wow-blog' ),
						'pro'   => __( 'Multiple Options', 'wow-blog' ),
					),
					array(
						'title' => __( 'Related Post Options', 'wow-blog' ),
						'desc'  => __( 'Manage the every entity of related posts.', 'wow-blog' ),
						'free'  => __( 'Enable/Disable', 'wow-blog' ),
						'pro'   => __( 'Multiple Options', 'wow-blog' ),
					),
					array(
						'title' => __( 'Copyright Text', 'wow-blog' ),
						'desc'  => __( 'Is there any options for Copyright Text?', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Social Options', 'wow-blog' ),
						'desc'  => __( 'Options to manage the social icons like facebook, instagram, linkedin etc.', 'wow-blog' ),
						'free'  => __( 'Limited', 'wow-blog' ),
						'pro'   => __( 'Multiple Options', 'wow-blog' ),
					),
					array(
						'title' => __( 'Theme Credit Link', 'wow-blog' ),
						'desc'  => __( 'Options to disable to Powered by text on footer.', 'wow-blog' ),
						'free'  => __( 'No Options To Disable', 'wow-blog' ),
						'pro'   => __( 'Enable/Disable', 'wow-blog' ),
					),
					array(
						'title' => __( 'Own Credit Link', 'wow-blog' ),
						'desc'  => __( 'Write your own credit text.', 'wow-blog' ),
						'free'  => 'no',
						'pro'   => __( 'Your Own Credit Text', 'wow-blog' ),
					),
					array(
						'title' => __( 'Social Icons', 'wow-blog' ),
						'desc'  => __( 'Enter the URL for social icons. ', 'wow-blog' ),
						'free'  => __( '4 +', 'wow-blog' ),
						'pro'   => __( 'Available Mostly Used', 'wow-blog' ),
					),
					array(
						'title' => __( 'Intro Loader Options', 'wow-blog' ),
						'desc'  => __( 'It will load before the site loaded completely.', 'wow-blog' ),
						'free'  => 'no',
						'pro'   => __( 'Multiple Options', 'wow-blog' ),
					),
					array(
						'title' => __( 'Author Info Options', 'wow-blog' ),
						'desc'  => __( 'This will appear on single page and archive page of that author.', 'wow-blog' ),
						'free'  => 'no',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Feature Image Options', 'wow-blog' ),
						'desc'  => __( 'Featured image options for the single page and post.', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => __( 'Manage As Your Need', 'wow-blog' ),
					),
					array(
						'title' => __( 'Navigation Options', 'wow-blog' ),
						'desc'  => __( 'Post Navigation means, previous post and next post. Check on single post.', 'wow-blog' ),
						'free'  => __( 'Default', 'wow-blog' ),
						'pro'   => __( 'Advanced', 'wow-blog' ),
					),
					array(
						'title' => __( 'Post Comment Options', 'wow-blog' ),
						'desc'  => __( 'Manage the comment section on single post.', 'wow-blog' ),
						'free'  => 'no',
						'pro'   => __( 'Options Available', 'wow-blog' ),
					),
					array(
						'title' => __( 'Show/Hide Comment', 'wow-blog' ),
						'desc'  => __( 'Options to show hide comments on page and post.', 'wow-blog' ),
						'free'  => 'no',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Breadcrumb', 'wow-blog' ),
						'desc'  => __( 'Advanced options for manage the Breadcrumb.', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => __( 'Advanced', 'wow-blog' ),
					),
					array(
						'title' => __( 'Video Post On Featured', 'wow-blog' ),
						'desc'  => __( 'Create your video post easily from Youtube and Vimeo video.', 'wow-blog' ),
						'free'  => 'no',
						'pro'   => __( 'Add Own Video On Featured', 'wow-blog' ),
					),
					array(
						'title' => __( 'Single Post Options', 'wow-blog' ),
						'desc'  => __( 'Manage every entity of single post.', 'wow-blog' ),
						'free'  => __( 'Limited', 'wow-blog' ),
						'pro'   => __( 'Multiple Options', 'wow-blog' ),
					),
					array(
						'title' => __( 'Featured Image Size', 'wow-blog' ),
						'desc'  => __( 'Select the size of the featured image on the single post.', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Image Size Options', 'wow-blog' ),
						'desc'  => __( 'Make the image size as your need on blog/archive page.', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Sidebars', 'wow-blog' ),
						'desc'  => __( 'Global and Individual sidebars are available. You can easily orveride it from single page/post.', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => __( 'Global And Individuals', 'wow-blog' ),
					),
					array(
						'title' => __( 'Introduction Loader Options', 'wow-blog' ),
						'desc'  => __( 'Is there any pre loader on theme ?', 'wow-blog' ),
						'free'  => 'no',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Advertisement', 'wow-blog' ),
						'desc'  => __( 'Is Advertisement options available on theme?.', 'wow-blog' ),
						'free'  => __( 'Image Only', 'wow-blog' ),
						'pro'   => __( 'Image and Codes', 'wow-blog' ),
					),
					array(
						'title' => __( 'Infinite Scroll Features Jetpack', 'wow-blog' ),
						'desc'  => __( 'Is theme have default infinite scroll ?', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Infinite Scroll', 'wow-blog' ),
						'desc'  => __( 'Use Jetpack Infinite Scroll on Blog Page', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Widget Area', 'wow-blog' ),
						'desc'  => __( 'Custom widget area available on theme', 'wow-blog' ),
						'free'  => __( '5+', 'wow-blog' ),
						'pro'   => __( '13+', 'wow-blog' ),
					),
					array(
						'title' => __( 'Sidebar After Content', 'wow-blog' ),
						'desc'  => __( 'Can we add advertisement on single post?', 'wow-blog' ),
						'free'  => 'no',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Tabbed Widget', 'wow-blog' ),
						'desc'  => __( 'Is tabbed widget available on theme?', 'wow-blog' ),
						'free'  => 'no',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'WooCommerce', 'wow-blog' ),
						'desc'  => __( 'Create WooCommerce shop easily with the help of WooCommerce plugin.', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Translation', 'wow-blog' ),
						'desc'  => __( 'Both theme are translation ready.', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'SEO', 'wow-blog' ),
						'desc'  => __( 'Developed with high skilled SEO tools.', 'wow-blog' ),
						'free'  => 'yes',
						'pro'   => 'yes',
					),
					array(
						'title' => __( 'Widget Area On Footer', 'wow-blog' ),
						'desc'  => __( 'Change the number of footers on footer area as you need.', 'wow-blog' ),
						'free'  => __( '3 ', 'wow-blog' ),
						'pro'   => __( 'Choose On Need', 'wow-blog' ),
					),
					array(
						'title' => __( 'Support Forum', 'wow-blog' ),
						'desc'  => __( 'Highly dedicated support team are assigned for your help. Try this today.', 'wow-blog' ),
						'free'  => __( 'Second', 'wow-blog' ),
						'pro'   => __( 'Dedicated With High Priority', 'wow-blog' ),
					),
				),
			);
		}
		...
		function at_admin_menu() {
			...
			$this->config     = $this->get_config();
			$this->page_title = isset( $this->config['page_title'] ) ? $this->config['page_title'] : esc_html__( 'Info', 'wow-blog' ) . $this->theme_name;
			$this->menu_title = isset( $this->config['menu_title'] ) ? $this->config['menu_title'] : esc_html__( 'Info', 'wow-blog' ) . $this->theme_name;
		...
		public function recommended_actions() {
			...
			if ( ! empty( $recommended_actions ) ) {
						...
						if ( ! empty( $plugin_slug ) ) {
							...
							switch ( $active['needs'] ) {
								...
								case 'install':
									...
									$label = esc_html__( 'Install', 'wow-blog' );
									break;

								case 'activate':
									$class = 'activate-now button button-primary';
									$label = esc_html__( 'Activate', 'wow-blog' );

									break;

								case 'deactivate':
									$class = 'deactivate-now button';
									$label = esc_html__( 'Deactivate', 'wow-blog' );
				...
				if ( $hooray ) {
					echo '<span class="hooray">' . esc_html__( 'Hooray! There are no recommended actions for you right now.', 'wow-blog' ) . '</span>';
					echo '<a data-action="reset" id="reset" class="reset-all" href="#">' . esc_html__( 'Show All Recommended Actions', 'wow-blog' ) . '</a>';
				}
				echo '</div>';
			}
		}
						...
						if ( ! empty( $screenshot ) ) {
							...
							if ( ! empty( $title ) ) {
								...
								if ( ! empty( $download_link ) ) {
									echo '<a href="' . esc_url( $download_link ) . '" class="button button-primary install right">' . esc_html__( 'Download', 'wow-blog' ) . '</a>';
								}
								if ( ! empty( $preview_link ) ) {
									echo '<a class="button button-secondary preview right" target="_blank" href="' . $preview_link . '">' . esc_html__( 'Live Preview', 'wow-blog' ) . '</a>';
								}
								echo '</div>';
								echo '</div>';
							}
		...
		public function free_pro() {
			...
			if ( ! empty( $free_pro ) ) {
				...
				if ( ! empty( $free_pro ) && is_array( $free_pro ) ) {
					...
					echo '<tr>';
					echo '<th></th>';
					echo '<th>' . esc_html__( 'WOW Blog', 'wow-blog' ) . '</th>';
					echo '<th>' . esc_html__( 'Read More Pro', 'wow-blog' ) . '</th>';
					echo '</tr>';
					echo '</thead>';
					echo '<tbody>';
